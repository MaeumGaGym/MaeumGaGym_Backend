...
internal class FileAdapter(
    ...
    override fun getPreSignedURL(fileType: String): com.info.maeumgagym.core.pickle.dto.PreSignedUploadURLDto = try {
        fileClient.preSignedUploadURLForVideo(
            fileProperty.secretKey,
            PreSignedUploadURLFeignRequest(fileType)
        ).run {
            com.info.maeumgagym.core.pickle.dto.PreSignedUploadURLDto(uploadURL, videoId)
        }
