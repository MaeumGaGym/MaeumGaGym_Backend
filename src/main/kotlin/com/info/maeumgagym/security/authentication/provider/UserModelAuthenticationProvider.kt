 ...
 * @since 02-04-2024
 */
interface UserModelAuthenticationProvider {

    /**
     * 생성한 [UserModelAuthentication]의 [user][UserModelAuthentication.user]를 [username]를 기반으로 유저를 탐색해 삽입 후 반환
     */
    fun getAuthentication(username: String): UserModelAuthentication

    /**
     * [user][UserModelAuthentication.user]가 비어있는 [UserModelAuthentication] 반환
     */
