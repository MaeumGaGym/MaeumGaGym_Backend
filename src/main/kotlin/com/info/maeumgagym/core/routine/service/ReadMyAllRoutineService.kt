...
internal class ReadMyAllRoutineService(
    ...
    override fun readAllMyRoutine(index: Int): com.info.maeumgagym.core.routine.dto.response.RoutineListResponse {
        // 토큰으로 유저 찾기
        ...
        // 반환
        return com.info.maeumgagym.core.routine.dto.response.RoutineListResponse(
            // 루틴 리스트 돌면서 List<RoutineResponse>로 매핑
            routineList = routineList.map { it.toResponse() },
            // 유저 정보
            userInfo = com.info.maeumgagym.core.user.dto.response.UserResponse(
