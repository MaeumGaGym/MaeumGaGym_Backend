package com.info.maeumgagym.application.domain.user.entity

import com.info.maeumgagym.application.TableNames
import com.info.maeumgagym.application.domain.base.BaseUUIDEntity
import com.info.maeumgagym.application.domain.user.converter.RoleConverter
...
class UserJpaEntity(
    nickname: String,
    oauthId: String,
    roles: MutableList<com.info.maeumgagym.core.user.model.Role>,
    profileImage: String?,
    ...
    var roles: MutableList<com.info.maeumgagym.core.user.model.Role> = roles
        protected set
